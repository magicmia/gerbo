...
const Event = () => {
  return (
    <div className="flex-col flex justify-center align-middle ">
      <Line />
      <div className="flex flex-row justify-between mx-5 mb-5 font-bold uppercase">
        <div className="flex flex-col justify-between w-1/3">
          <h1 className="my-5"> A csodás előadás ideje</h1>
          <div>
            <h1 className="my-5">és időpontja</h1>
          </div>
        </div>
      ...
      <button
        ...
        className="w-3/4 self-center md:text-center h-12 text-sm bg-black text-white uppercase cursor-pointer rounded flex justify-center align-middle p-2"
      >
        JEGYEK
      </button>
      <div
        onClick={"fbEvent"}
        className="self-center my-5 uppercase flex justify-center align-middle p-2 font-bold text-base"
      >
        FACEBOOK ESEMÉNY
      </div>
      <h1 className="mx-5 font-bold uppercase">ez itt a kert </h1>
      ...
      <div className="w-full h-80 p-6 justify-center flex">
